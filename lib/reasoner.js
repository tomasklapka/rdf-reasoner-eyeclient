 ...
 * TODO:
 * - I don't like the data thing copied to the abstract class from EyeClient input API.
 * solution: create abstract api for defining Reasoning rules
 * - sameAs/isDefinedBy/... importing
 */
